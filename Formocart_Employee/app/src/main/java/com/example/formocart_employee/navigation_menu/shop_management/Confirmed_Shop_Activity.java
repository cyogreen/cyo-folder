...
public class Confirmed_Shop_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirmed__shop_);
        final SwipeRefreshLayout pullToRefresh = findViewById(R.id.pullToRefresh);
        pullToRefresh.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh() {
                Intent i = new Intent(Confirmed_Shop_Activity.this, Confirmed_Shop_Activity.class);
                startActivity(i);
        ...
        sessionManager=new SessionManager(Confirmed_Shop_Activity.this);
        ll = (TableLayout) findViewById(R.id.tabla_cuerpo);
        get_confirmed_shop();
        drawer = (DrawerLayout) findViewById(R.id.drawer);
        DrawerClass drawerClass = new DrawerClass(Confirmed_Shop_Activity.this);
        drawerClass.getDrawerFunctionality(this.findViewById(android.R.id.content),drawer);
    }
    private void get_confirmed_shop() {
        dataArray=new ArrayList<>();
        final ProgressDialog pd = new ProgressDialog(Confirmed_Shop_Activity.this);
        ...
        CustomJsonArrayRequest req = new CustomJsonArrayRequest(Request.Method.POST, A_Service_URL.getUrl + "shopmng_empl.php",
            ...
            public void onResponse(JSONArray response) {
                try {
                    ...
                    A_Service_URL.getToast(Confirmed_Shop_Activity.this, "" + e);
                    pd.dismiss();
                    e.printStackTrace();
                }
            }
        ...
        RequestQueue rq = Volley.newRequestQueue(Confirmed_Shop_Activity.this);
        rq.add(req);
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(Confirmed_Shop_Activity.this,ShopManagementListing_Activity.class));
    }
}
