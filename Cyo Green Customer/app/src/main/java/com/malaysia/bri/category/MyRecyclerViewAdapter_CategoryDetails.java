...
public class MyRecyclerViewAdapter_CategoryDetails extends RecyclerView.Adapter<MyRecyclerViewAdapter_CategoryDetails.ViewHolder> {

    private final Context context;
    private final SessionManager sessionManager;
    private ArrayList<CustomClass_Fruits> mData;
    private LayoutInflater mInflater;
    private ItemClickListener mClickListener;

    // data is passed into the constructor
    public MyRecyclerViewAdapter_CategoryDetails(Context context, ArrayList<CustomClass_Fruits> data) {
