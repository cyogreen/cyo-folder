...
$ext = pathinfo($imagename, PATHINFO_EXTENSION);
 if(in_array($ext,$extension)){
     $imgRANDMR=rand(99999,10000);
             ...
             $coverImgdir = '/home/getmlmsoftware/public_html/demo/cyo/admin/assets/shops/'.$shp_id.'/'.'imgs/';
...
$ext2 = pathinfo($imagename2, PATHINFO_EXTENSION);
 if(in_array($ext2,$extension2)){
     $imgRANDMR2=rand(99999,10000);
              ...
              /*generating random image name ed*/
             $coverImgdir2 = '/home/getmlmsoftware/public_html/demo/cyo/admin/assets/shops/'.$shp_id.'/'.'imgs/';
...
$ext3 = pathinfo($imagename3, PATHINFO_EXTENSION);
 if(in_array($ext3,$extension3)){
     $imgRANDMR3=rand(99999,10000);
              ...
              /*generating random image name ed*/
             $coverImgdir3 = '/home/getmlmsoftware/public_html/demo/cyo/admin/assets/shops/'.$shp_id.'/'.'imgs/';
              ...
              if($qry){
                 ...
                 if($sucrd){
                     ...
                     <script>
                         ...
                         var psd='<?php echo $shp_psd;?>';
                         var email='<?php echo $semail;?>';
                         
                         if($.post('adshopotp.php',{shpnme:shpnme,smobile:smobile,psd:psd,email:email},function(data){
                             ver=data;
                         })){
